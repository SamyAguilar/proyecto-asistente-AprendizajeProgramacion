...
class AppConstants {
  ...
  // ENDPOINTS DE GEMINI/IA (LUZIA)

  // ENDPOINTS COMPLETOS DE LUZIA

  // POST /gemini/chat - Chat con LUZIA
  static String get chatLuziaUrl => '$apiUrl/gemini/chat';

  // POST /gemini/explicar-concepto - Explicar conceptos de programacion
  ...
  // POST /gemini/validate-code - Analizar/validar codigo
  ...
  // NUEVO - Timeout especial para Gemini (respuestas mas largas)
  static const int geminiTimeout = 60;

  // CONFIGURACION DE LUZIA

  // Maximo de mensajes en el historial del chat
  static const int maxHistorialChat = 50;

  // Maximo de caracteres para codigo a analizar
  ...
  // NUEVO - Error especifico de LUZIA
  static const String errorLuzia = 'LUZIA no pudo procesar tu solicitud. Intenta de nuevo.';
